...
function gotResult(error, results) {
    if(error){
        ...
        if(results[0].label == "Barking"){
            img.src = "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.shutterstock.com%2Fsearch%2Fdog-cartoon&psig=AOvVaw1ueZepOKESzmDta2VGDFSd&ust=1686046247921000&source=images&cd=vfe&ved=0CA4QjRxqFwoTCNCOiO_xq_8CFQAAAAAdAAAAABAE";
            dog = dog+1;
            document.getElementById("detected").innerHTML = "Detected Dog - "+ dog;
        }
        else if(results[0].label == "Meowing"){
            img.src = "https://www.google.com/url?sa=i&url=https%3A%2F%2Fstock.adobe.com%2Fbg%2Fsearch%3Fk%3Dcat%2520cartoon&psig=AOvVaw29yHLCGMfrPnntqceJRZK3&ust=1686046320496000&source=images&cd=vfe&ved=0CA4QjRxqFwoTCLCYvpDyq_8CFQAAAAAdAAAAABAE";
            cat = cat+1;
